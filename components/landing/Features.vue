...
<div class="mt-16 md:mt-0">
  <h2 class="text-4xl lg:text-5xl font-bold lg:tracking-tight font-serif">
    Everything you need to start a website
  </h2>
  <p class="mt-4 font-serif">
    Nuxt come batteries included. It takes the beast parts of state-of-the-art tools and adds its own innovations.
  </p>
